...
enum Command {
    ...
    /// Increment 65: authorable use (held token at the exit).
    Increment65 {
        #[arg(long, default_value = "artifacts/increment65")]
        out: PathBuf,
        #[arg(long, default_value_t = INCREMENT65_STEPS)]
        steps: u32,
        #[arg(long, default_value_t = FRAME_WIDTH)]
        width: u32,
        #[arg(long, default_value_t = FRAME_HEIGHT)]
