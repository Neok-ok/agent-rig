...
use agent_rig::{
    ...
    run_increment5, run_increment6, run_increment7, run_increment8, run_increment9, run_increment10, sim_scene_file, step_scene_file, DEFAULT_DT,
    ...
    INCREMENT9_STEPS, INCREMENT10_STEPS,
};
...
fn main() {
    ...
    let result = match args.command {
        ...
        None => {
            eprintln!("usage: agent-rig <demo|increment2|increment3|increment4|increment5|increment6|increment7|increment8|increment9|increment10|sim|step|render> …  (or --demo for increment 1)");
            std::process::exit(2);
        }
    };
