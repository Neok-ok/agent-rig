//! Agent-native scene + physics inspect + headless PNG (increments 1–62).
...
pub use physics::{simulate_trajectory, step_physics, step_physics_with_carry, step_catalog_scene, step_catalog_scene_with_carry, BrokenJoint, ContactEvent, ControllerState, DespawnRecord, DumpCamera, DroppedRecord, HeldRecord, PhysicsBodyState, PhysicsContact, PhysicsDump, PhysicsOverlap, PhysicsJoint, PickupRecord, SpawnRecord, StoppedRecord, Trajectory, TrajectoryFrame, TransitionRecord};
