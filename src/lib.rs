//! Agent-native scene + physics inspect + headless PNG (increments 1–47).
...
pub use physics::{simulate_trajectory, step_physics, BrokenJoint, ContactEvent, PhysicsBodyState, PhysicsContact, PhysicsDump, PhysicsOverlap, PhysicsJoint, Trajectory, TrajectoryFrame};
