//! Agent-native scene + physics inspect + headless PNG (increments 1–57).
...
pub use physics::{simulate_trajectory, step_physics, BrokenJoint, ContactEvent, ControllerState, DespawnRecord, DumpCamera, DroppedRecord, HeldRecord, PhysicsBodyState, PhysicsContact, PhysicsDump, PhysicsOverlap, PhysicsJoint, PickupRecord, SpawnRecord, StoppedRecord, Trajectory, TrajectoryFrame};
